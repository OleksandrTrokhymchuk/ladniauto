        ...
        <div className="container mx-auto custom-container flex items-center justify-between">
          ...
          <div className="md:hidden">
                <div className="flex items-center gap-x-5 ">
                        ...
                        <svg className={`md:hidden transition-all duration-700 ease-in-out
                                ${isPulsing ? 'brightness-150 drop-shadow-lg' : ''}` } width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
