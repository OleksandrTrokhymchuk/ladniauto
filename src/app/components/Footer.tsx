    ...
    <footer className="bg-project-blue py-6 text-project-white">
      <div className="custom-container flex flex-col items-center md:flex-row md:justify-around md:items-center space-y-8 md:space-y-0">
        <div className="flex flex-col items-center space-y-4">
          <address className="not-italic font-bold">м. Київ, Україна</address>
          <a
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            <span
              className="absolute inset-0 rounded-full border border-project-white opacity-0 scale-75 transition-all duration-500
                            group-hover-supported:group-hover:opacity-100 group-hover-supported:group-hover:scale-110
                            group-no-hover:group-active:opacity-100 group-no-hover:group-active:scale-110"
            ></span>
            <Image
              src={youtubeIcon}
              width={36}
