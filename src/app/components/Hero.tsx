      ...
      <div className="custom-container vsm:text-lg lg:text-xl">
        <div className="vsm:min-h-[calc(100vh-112px)] md:min-h-0 md:mb-20">
          <h1
            ...
            style={{
              textShadow:
                "0 0 1px rgba(255, 255, 255, 0.2), 0 0 2px rgba(255, 255, 255, 0.2), 0 0 3px rgba(255, 255, 255, 0.2)",
            }}
          >
          ...
          <div className="flex flex-col gap-y-6 mb-16">
            <h2>
              Ми не продаємо авто – ми продаємо спокій. Реалізовуємо
              автомобільні мрії клієнтів.
            </h2>
            <p>
              Від аукціону США до видачі відновленого авто у вашому місті.{" "}
              <br />
              Купуємо безпечні, а віддаємо готові. Ви обираєте – ми робимо
              результат. <br />
              Чесно. Прозоро. Без зайвих турбот.
            </p>
          </div>
          <div className="">
            <p
            ...
            >
              Залишайте заявку на персональну консультацію та безкоштовний
              підбір!
            </p>
